...
from RNN.rnn_emb_disaggregator import RNNEmbeddingsDisaggregator
...
MODEL_NAME = "RNN"
# dae = RNNEmbeddingsDisaggregator(WINDOW_KETTLE, clustering_model, trainable)
...
# dae = RNNEmbeddingsDisaggregator(WINDOW_MICROWAVE, clustering_model, trainable)
# experiment = Experiment(train_dataset_name=UK_DALE_NAME,
#                         name=MODEL_NAME,
#                         disaggregator=dae,
#                         train_dataset_path=UK_DALE,
...
# dae = RNNEmbeddingsDisaggregator(WINDOW_FIRDGE, clustering_model, trainable)
# experiment = Experiment(train_dataset_name=UK_DALE_NAME,
#                         name=MODEL_NAME,
#                         disaggregator=dae,
#                         train_dataset_path=UK_DALE,
...
dae = RNNEmbeddingsDisaggregator(WINDOW_DISH_WASHER, clustering_model, trainable)
experiment = Experiment(train_dataset_name=UK_DALE_NAME,
                        name=MODEL_NAME,
                        disaggregator=dae,
                        train_dataset_path=UK_DALE,
